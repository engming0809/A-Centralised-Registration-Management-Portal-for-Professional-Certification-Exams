...
try {
    ...
    $query = "
        SELECT r.registration_id, r.registration_status, r.created_at, r.updated_at, 
               ...
               pi.filepath AS payment_invoice_path,
               ts.filepath AS transaction_slip_path,
               pr.filepath AS payment_receipt_path,
               ecl.filepath AS exam_confirmation_letter_path,
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($registration['payment_invoice_path'])): ?>
                                    <object data="<?= htmlspecialchars($registration['payment_invoice_path']) ?>" type="application/pdf">
                                        <p><a href="<?= htmlspecialchars($registration['payment_invoice_path']) ?>">Download the PDF</a>.</p>
                                    </object>
                                <?php else: ?>
                                    N/A
                                <?php endif; ?>
                            ...
                            <td>
                                <?php if (!empty($registration['payment_receipt_path'])): ?>
                                    <object data="<?= htmlspecialchars($registration['payment_receipt_path']) ?>" type="application/pdf">
                                        <p><a href="<?= htmlspecialchars($registration['payment_receipt_path']) ?>">Download the PDF</a>.</p>
                                    </object>
                                <?php else: ?>
                                    N/A
                                <?php endif; ?>
                            ...
                            <td>
                                <?php if (!empty($registration['certificate_path'])): ?>
                                    <object data="<?= htmlspecialchars($registration['certificate_path']) ?>" type="application/pdf">
