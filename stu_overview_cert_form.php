                ...
                <div class="form-group row">
                    <div class="col-md-4">
                        ...
                        <input id="ic_num_1_textbox" type="number" class="form-control" name="ic_num_1_textbox" 
                            ...
                            pattern="^\d{6}$" min="0" max="999999" required value="<?php echo htmlspecialchars($form_data['ic_num_1_textbox'] ?? ''); ?>">
                    </div>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                    <div class="col-md-4">
                        ...
                        <input id="phone_code_textbox" type="number" class="form-control" name="phone_code_textbox" required 
                            ...
                            maxlength="3" pattern="\d{3}" title="Please enter exactly 3 digits" value="<?php echo htmlspecialchars($form_data['phone_code_textbox'] ?? ''); ?>" />
                    </div>
                    <div class="col-md-8">
