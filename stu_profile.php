...
<main>
        ...
        $query = "SELECT full_name, email, profileimg, password, biography, status FROM Student WHERE email = '$email'";
        ...
        $biography = $student_info['biography'];
        $hashed_password = $student_info['password'];
    
        // Handle the form submission for updating the name
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_name'])) {
            $new_full_name = $_POST['full_name'];
            $update_query = "UPDATE Student SET full_name = '$new_full_name' WHERE email = '$email'";
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['change_password'])) {
        ...
        if (password_verify($old_password, $hashed_password)) {
            ...
            $update_query = "UPDATE Student SET password = '$new_hashed_password' WHERE email = '$email'";
            if (mysqli_query($conn, $update_query)) {
    ...
    if (isset($_SESSION['password_change_message'])) {
        ...
        <button id="stuEditImageButton" class="btn btn-info btn-sm" data-toggle="modal" data-target="#uploadImageModal">
    ...
    function saveFullName() {
        ...
        xhr.open("POST", "stu_profile_edit.php", true);
    ...
    $(document).ready(function() {
        $('#uploadImageForm').on('submit', function(event) {
            ...
            $.ajax({
                url: 'upload_image_stu.php', // PHP script to handle the upload
                type: 'POST',
                data: formData,
