...
<!-- Main Content -->
    <main class="container-fluid stu_dashboard py-5">
        <div class="row">
            <div class="col-md-8">
                <div class="card shadow-sm mb-4 border-light rounded">
                    <div class="card-body">
                        <h5 class="card-title">Welcome, <?php echo $_SESSION['student_full_name']; ?> <i class="fas fa-user-graduate"></i></h5>
                        <p class="card-text">
            ...
            <div class="col-md-4">
                <div class="card shadow-sm mb-4 border-light rounded">
                    ...
                    <div class="card-body">
                        <p><strong>Logged in as:</strong> <?php echo $_SESSION['student_full_name']; ?></p>
                        <p><strong>Your Student Email:</strong> <?php echo $_SESSION['student_email']; ?></p>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>View a list of available certifications, along with their schedules, deadlines, and more detailed information.</td>
                        </tr>
                        <tr>
                            <td><strong>My Registration</strong></td>
                            <td>See all the exams you’ve registered for, along with payment status, deadlines, and upcoming exam dates.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
