    ...
    <section class="container">
        <section class="row login_container">
            ...
            <div class="col-md-6 d-none d-md-block p-0">
                ...
                <!-- https://www.european-microfinance.org/sites/default/files/news/cover_image/e-learning.jpg -->
            </div>
            ...
            <div class="col-md-6 form-section">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if (filter_var($email, FILTER_VALIDATE_EMAIL) && !empty($password)) {
                        ...
                        $stmt = $conn->prepare("SELECT full_name, password, status FROM Student WHERE email = ?");
                        ...
                        if ($stmt->num_rows > 0) {
                            $stmt->bind_result($fullname, $hashed_password, $status);
                            $stmt->fetch();
